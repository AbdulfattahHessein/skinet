...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251215183716_UpdateOrderStatues")]
    partial class UpdateOrderStatues
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Entities.OrderAggregate.Order", b =>
                {
                    ...
                    b.ToTable("Orders", t =>
                        {
                            t.HasCheckConstraint("CK_Order_Status_Valid", "[Status] IN ('Pending', 'PaymentReceived', 'PaymentFailed', 'PaymentMismatch')");
                        });
                });
