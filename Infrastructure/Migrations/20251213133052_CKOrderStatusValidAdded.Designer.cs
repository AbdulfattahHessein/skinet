...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251213133052_CKOrderStatusValidAdded")]
    partial class CKOrderStatusValidAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Entities.OrderAggregate.Order", b =>
                {
                    ...
                    b.ToTable("Orders", t =>
                        {
                            t.HasCheckConstraint("CK_Order_Status_Valid", "[Status] IN ('Pending', 'PaymentReceived', 'PaymentFailed')");
                        });
                });
